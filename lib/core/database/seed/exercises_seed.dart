  ...
  static List<ExercisesCompanion> get all {
    ...
    return [
      ...
      ExercisesCompanion.insert(
        ...
        emoji: '🦅',
        stepsJson: json.encode([
          'Posición inicial. Siéntate al borde de la silla con los pies planos en el suelo. Espalda recta, hombros relajados.',
          'Entrelaza las manos. Lleva ambas manos detrás de la espalda baja y entrelaza los dedos firmemente.',
          'Abre el pecho. Inhala mientras llevas los hombros hacia atrás y los brazos entrelazados se alejan de tu espalda hacia abajo.',
          'Mantén 20 a 30 segundos. Con cada inhalación el pecho se abre más. Con cada exhalación los hombros se relajan más atrás.',
          'Qué debes sentir. Estiramiento en el pecho y la parte frontal de los hombros. No arquees en exceso la zona lumbar.',
          'Precaución. Si sientes dolor en los hombros o la espalda baja, reduce el rango de movimiento.',
        ]),
        createdAt: now,
      ),
